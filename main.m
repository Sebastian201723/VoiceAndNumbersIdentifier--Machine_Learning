...
%% C�lculo del espectro de potencia
...
Fs = Fs1/3; 
y = downsample(sx,3); %Submuestramos a 10 por se�al
...
%% Compensaci�n por retardo de grupo
% Este m�todo sirve en retardos constantes (Filtros FIR)
...
%% Dise�o del filtro de rechazo de banda para eliminar el humming
% Se dise�ar� para rechazar una banda de 4 Hz centrada en 60 Hz
...
%% Compensaci�n de retardo de grupo
